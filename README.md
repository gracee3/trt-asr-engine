...
- **Min chunk constraint**: TRT streaming encoder profile requires `audio_signal.T >= 41`; runtime pads tail chunks shorter than 41 (zero‑pad) while preserving `length=T_actual`.
